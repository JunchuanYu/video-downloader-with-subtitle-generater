...
class YouTubeDownloader(Downloader):
    ...
    def download(self):
        ...
        return {'file': f"{info['id']}.{info['ext']}",'fulltitle': info['title'],'subtitle': info['subtitles'], 'uploader': info['uploader'],'data': info['upload_date'],'resolution': info['resolution'],'thumbnail':info['thumbnail'],'description':info['description']}
